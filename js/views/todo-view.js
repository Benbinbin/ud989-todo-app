...
(function ($) {
	...
	app.TodoView = Backbone.View.extend({
		...
		initialize: function () {
			...
			this.listenTo(this.model, 'visible', this.togglePriorityVisible);
		},
		...
		togglePriorityVisible: function () {
			this.$el.toggleClass('hidden', this.isHiddenPriority());
		},

		isHiddenPriority: function () {
